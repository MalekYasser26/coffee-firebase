  ...
  Widget build(BuildContext context) {
    return  Padding(
      ...
      child: TextFormField(
        ...
        controller: Provider.of<FormProviders>(context,listen : false).emailController,
        ...
        validator: (value) {
          ...
          RegExp(r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+")
              .hasMatch(Provider.of<FormProviders>(context,listen: false).emailRegController.text!)==true)
          {
